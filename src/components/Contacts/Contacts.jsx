    ...
    <div className={'container'}>
      ...
      <p className={'text-container'}>
        <p className={'text-form'}>
          Важно!
          <br />
          Пожалуйста обратите внимание, что фактические цвета могут отличаться от изображения на экране. Все произведения являются исключительной собственностью художника Lina Missa. Любое копирование, сбор и использование изображений
